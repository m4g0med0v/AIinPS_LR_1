...
# для начального населенного пункта (Гудермес) на построенном графе.
# Оцените время решения данной задачи, если оно окажется достаточно большим,
# уменьшите количество узлов и ребер графа. Покажите полученный путь на
# построенном графе.
